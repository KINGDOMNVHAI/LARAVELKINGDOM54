                ...
                <div class="content_middle_middle">
                    <div class="slick_slider2">
                        ...
                        @foreach($newest as $new)
                            <div class="single_featured_slide"> <a href="#"><img src="upload/images/thumbnail/{{ $new->imgDetailPost }}" alt=""></a>
                    ...
                    <div class="single_bottom_rightbar">
                        ...
                        <ul class="small_catg popular_catg wow fadeInDown">
                            @foreach($updates as $update)
                                <li>
                                    <div class="media wow fadeInDown"> <a href="{{ route('post-content', $update->urlDetailPost ) }}" class="media-left"><img alt="" src="upload/images/thumbnail/{{ $update->imgDetailPost }}"> </a>
                            ...
                            <div id="mostPopular" class="tab-pane fade in active" role="tabpanel">
                                <ul class="small_catg popular_catg wow fadeInDown">
                                    ...
                                    @foreach ($mostViews as $view)
                                        <li>
                                            <div class="media wow fadeInDown"> <a class="media-left" href="{{ route('post-content', $view->urlDetailPost ) }}"><img src="upload/images/thumbnail/{{ $view->imgDetailPost }}"alt=""></a>
                                                <div class="media-body">
                            ...
                            <div id="recentComent" class="tab-pane fade" role="tabpanel">
                                <ul class="small_catg popular_catg">
                                    @foreach($random as $rand)
                                        <li>
                                            <div class="media wow fadeInDown"> <a class="media-left" href="{{ route('post-content', $rand->urlDetailPost ) }}"><img src="upload/images/thumbnail/{{ $rand->imgDetailPost }}" alt=""></a>
                                                <div class="media-body">
